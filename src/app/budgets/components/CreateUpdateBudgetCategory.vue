<template>
  <tr id="budget-category-create-edit-view">
      ...
      <td>
  <!-- imported custom widget for select inputs
       that allows user to add categories -->
        <multiselect
...
import Multiselect from 'vue-multiselect'; // npm install vue-multiselect@next --save
...
export default {
  ...
  methods: {
    ...
    updateCategorySelection (category) {
      ...
      // vue-multiselect seems to struggle to properly
      // keep its internal value up to date with the value in our component.
      // So we're skipping v-model and handling updates manually.
