<template>
    ...
    <nav class="level">
      ...
      <div class="level-right">
        <div class="level-item">
          <router-link :to="{ name: 'createAccount' }" class="button is-primary">
            Add Account +
          </router-link>
        </div>
      </div>
  ...
  <!-- end header -->
    ...
    <table class="table is-bordered">
      ...
      <tbody>
        <!--account is object, key is index of object -->
...
/**
 * Holds data values for attributes
 *  bound to the vue intance.
 */
  data () {
    return {
